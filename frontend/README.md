# Aurelia storefront — developer documentation

The Next.js application. For the project pitch, feature list and route table,
see the [root README](../README.md); this document covers **how it is built**.
...
- [Architecture](#architecture)
  ...
  - [URL-driven catalogue](#url-driven-catalogue)
  - [Business logic outside JSX](#business-logic-outside-jsx)
  - [Client state](#client-state)
- [Swapping the mock data for a real API](#swapping-the-mock-data-for-a-real-api)
- [Design system](#design-system)
- [Accessibility](#accessibility)
- [Placeholder imagery](#placeholder-imagery)
...
[Quality gates](#quality-gates) has the one-liners that verify every rule above.
...
with API calls and the pure cart logic and every cart component stay as they are.
...
Scroll-reveal animation is scoped to a `.js` class set by an inline script, so
a visitor without JavaScript sees every section rather than a blank page.
